package com.primerworldapps.truthgame.appRater;

import com.primerworldapps.truthgame.R;
import com.primerworldapps.truthgame.appRater.ApplicationRatingInfo;
...
*/
    ...
    private static void showRateAlertDialog(final Context context, final SharedPreferences.Editor editor) {
        ...
        ApplicationRatingInfo ratingInfo = ApplicationRatingInfo.createApplicationInfo(context);
        builder.setTitle(String.format(context.getString(R.string.rate_title_text), ratingInfo.getApplicationName()));

        builder.setMessage(context.getString(R.string.rate_content_text));

        builder.setPositiveButton(context.getString(R.string.rate_ok_text),
        ...
        builder.setNeutralButton(context.getString(R.string.rate_later_text),
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        if (editor != null) {
        ...
        if (!hideNoButton) {
            builder.setNegativeButton(context.getString(R.string.rate_never_text),
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            if (editor != null) {
                                editor.putBoolean(PREF_DONT_SHOW_AGAIN, true);
